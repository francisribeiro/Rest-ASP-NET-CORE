-- --------------------------------------------------------
-- Servidor:                     127.0.0.1
-- Versão do servidor:           5.7.25-log - MySQL Community Server (GPL)
...
-- Copiando estrutura do banco de dados para rest_asp_net
CREATE DATABASE IF NOT EXISTS `rest_asp_net` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `rest_asp_net`;

-- Copiando estrutura para tabela rest_asp_net.books
...
-- Copiando dados para a tabela rest_asp_net.books: ~15 rows (aproximadamente)
DELETE FROM `books`;
...
-- Copiando estrutura para tabela rest_asp_net.changelog
...
-- Copiando dados para a tabela rest_asp_net.changelog: ~11 rows (aproximadamente)
DELETE FROM `changelog`;
/*!40000 ALTER TABLE `changelog` DISABLE KEYS */;
INSERT INTO `changelog` (`id`, `type`, `version`, `description`, `name`, `checksum`, `installed_by`, `installed_on`, `success`) VALUES
	(1, 2, '0', 'Empty schema found: rest_asp_net.', 'rest_asp_net', '', 'root', '2019-02-05 10:06:41', 1),
	(2, 0, '1.0.1', 'Create Table Persons', 'V1_0_1__Create_Table_Persons.sql', '3D83A729290DF11976DD1F562B6E7577', 'root', '2019-02-05 10:06:41', 1),
	(3, 0, '1.0.2', 'Alter Table Persons', 'V1_0_2__Alter_Table_Persons.sql', 'A33639F736C7DF27AD3C7093D4A46BDF', 'root', '2019-02-05 10:06:41', 1),
	(4, 0, '1.0.3', 'Create Table Books', 'V1_0_3__Create_Table_Books.sql', '0DEF984412F03E88CE0F2C2013F147B2', 'root', '2019-02-05 10:06:41', 1),
	(5, 0, '1.0.4', 'Insert data in books', 'V1_0_4__Insert_data_in_books.sql', '176BED6692EB72483D6293F87630A8EE', 'root', '2019-02-05 10:23:41', 1),
	(6, 0, '1.0.5', 'Insert data in persons', 'V1_0_5__Insert_data_in_persons.sql', '43BBD289A069861D69262F081AD4BAE2', 'root', '2019-02-05 10:23:41', 1),
	(7, 0, '1.0.6', 'Drop table books', 'V1_0_6__Drop_table_books.sql', '996116D4AC3B9566301DE7B869018E5E', 'root', '2019-02-06 14:02:09', 1),
	(8, 0, '1.0.7', 'Recreate table books', 'V1_0_7__Recreate_table_books.sql', 'CB5FB5A85E1A215AF7660C79FA4D9348', 'root', '2019-02-06 14:02:09', 1),
	(9, 0, '1.0.8', 'Reinsert data in books', 'V1_0_8__Reinsert_data_in_books.sql', '3AA7D3B32D6D452A58B268467172E07E', 'root', '2019-02-06 14:02:09', 1),
	(10, 0, '1.0.9', 'Create table users', 'V1_0_9__Create_table_users.sql', '21A098BE693C455B76FD57CA6ACE1D5F', 'root', '2019-02-11 09:12:00', 1),
	(11, 0, '1.0.10', 'Insert data in users', 'V1_0_10__Insert_data_in_users.sql', 'D5A73E85F99502520B2CA1E89600EF4E', 'root', '2019-02-11 09:12:00', 1),
	(12, 0, '1.0.11', 'Insert data in persons', 'V1_0_11__Insert_data_in_persons.sql', '5E14AA5E5E5A17FEC283A2D2014C18E2', 'root', '2019-02-11 16:11:21', 1);
/*!40000 ALTER TABLE `changelog` ENABLE KEYS */;

-- Copiando estrutura para tabela rest_asp_net.persons
...
-- Copiando dados para a tabela rest_asp_net.persons: ~302 rows (aproximadamente)
DELETE FROM `persons`;
...
-- Copiando estrutura para tabela rest_asp_net.users
...
-- Copiando dados para a tabela rest_asp_net.users: ~2 rows (aproximadamente)
DELETE FROM `users`;
